...
Если определить нельзя, ответь 0. В ответе должно быть одно целое число"
Output: ""
'''

# Можно брать батчами по 5-10 объявлений, сначала так и написал. 
# Так быстрее и меньше токенов, но:
# (1) не всегда в ответе на 7 объявлений 7 ответов, иногда выдает больше или меньше,
#   в итоге записать в файл датасета - отдельная проблема
# (2) ответы существенно точнее, если запрашивать по одному

if __name__ == "__main__":
    llm = ChatOpenAI(temperature=0.0, api_key=OPENAI_API_KEY, model_name='gpt-4o-mini-2024-07-18')
